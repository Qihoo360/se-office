...
import { ChromeEvent } from './chrome_event.d.ts'
...
declare global {
  export namespace chrome {
    export namespace tabs {
      ...
      export function create(createProperties: CreateProperties, callback?: (p1: Tab) => void): void

      export function update(
        tabId: number | undefined,
        updateProperties: UpdateProperties,
        callback?: (p1?: Tab) => void
      ): void
      ...
      export function getZoom(tabId: number | undefined, callback: (zoom: number) => void): void
      ...
      export function getZoomSettings(
        tabId: number | undefined,
        callback: (settings: ZoomSettings) => void
      ): void
